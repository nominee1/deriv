...
export const OSCARS_GRIND = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Denara Rise Fall strategy in Deriv Bot')],
        expanded: true,
    ...
    },
    {
        ...
        content: [
            localize(
                'The Denara Rise Fall strategy is designed to potentially gain a modest yet steady profit in each trading session. This strategy splits trades into sessions and has three principles.'
            ),
        ],
    },
    {
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used for Denara Rise Fall strategy in Deriv Bot.')],
    },
    {
        type: 'text',
        content: [
    ...
    {
        type: 'subtitle',
        content: [localize('An example of Denara Rise Fall strategy')],
    },
    {
        type: 'media',
        src: getImageLocation('oscars_grind.png'),
        alt: localize('An example of Denara Rise Fall strategy'),
    },
    {
        type: 'text',
        content: [
