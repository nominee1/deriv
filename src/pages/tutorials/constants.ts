...
export const VIDEOS = 'videos on Denara Strategies and Bots';
export const QUICK_STRATEGY_GUIDES = 'Denara Strategies guide';
...
export const user_guide_content = (): TUserGuideContent[] => [
    ...
    //     type: 'Tour',
    //     subtype: 'OnBoard',
    //     content: localize('Get started on Denara Bots'),
    ...
    // },
    {
        ...
        type: 'Tour',
        subtype: 'BotBuilder',
        content: localize('Load your dtrader bot'),
...
export const guide_content = (): TGuideContent[] => [
    ...
    },
    {
        id: 1,
        type: 'DBotVideo',
        content: localize('Unleash Digit Match Strategy'),
        url: 'https://www.youtube.com/embed/TbwGlEnOcyA',
    ...
    },
    {
        id: 2,
        type: 'DBotVideo',
        content: localize('Trading Less Risky Markets'),
        url: 'https://www.youtube.com/embed/nEBU_zTg6Uw',
    ...
    },
    {
        id: 3,
        type: 'DBotVideo',
        content: localize('Digit Match Strategy Using Multiplier Bot'),
        url: 'https://www.youtube.com/embed/OmhXlCKdxXc',
...
export const quick_strategy_content = (): TQuickStrategyContent[] => [
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Denara Rise Fall strategy in Deriv Bot'),
            localize('An example of Denara Rise Fall strategy'),
        ],
