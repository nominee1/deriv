...
export const DBOT_ONBOARDING = [
    {
        ...
        content: (
            <TourSteps
                label={<Localize i18n_default_text='Get started on Detrader Bot' />}
                content={[
                    <>
    ...
    },
    {
        ...
        content: (
            <TourSteps
                label={<Localize i18n_default_text='Monitor | Analyze the market with the power of denara at your fingertips' />}
                content={[
                    <Localize
                        key='view the market'
                        i18n_default_text='Harness the power of denara at your fingertips.'
                    />,
                ]}
...
export const DBOT_ONBOARDING_MOBILE: TMobileTourConfig[] = [
    {
        header: <Localize i18n_default_text='Get started on Denara Bots' />,
        content: [
...
export const getBotBuilderTourHeader = (is_mobile: boolean) => {
    ...
    return <Localize key='tour_header-desktop' i18n_default_text="Trade like a pro" />;
};
